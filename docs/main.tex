...
\tightlist
\item
  προσωπικό(ΑΜΚ, όνομα, επώνυμο, ηλικία, email, τηλέφωνο, ημερομηνία
  πλρόσληψης, τύπος προσωπικού)
\item
  γιατρός(ΑΜΚ, αριθμός άδειας γιατρικού συλλόγου, ειδικότητα, βαθμίδα)
\item
  νοσηλευτής(ΑΜΚ, βαθμίδα)
\item
  διοικητικό\_προσωπικό(ΑΜΚ, καθήκοντα/ρόλος)
\item
